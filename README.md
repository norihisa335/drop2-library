...
Home provides Browse by Voicing, Browse by Chord, Chord Changes (Study), and Chord Changes (Play). Supported families are Drop2, Drop3, Shell, and Triad, with 219 forms in total.

The Excel data master is the source of truth; `data.js` is generated from it.
